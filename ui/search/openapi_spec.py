...
def build_spec() -> dict:
    ...
    return {
        ...
        "paths": {
            ...
            # --- catalog endpoints ---
            "/views": {"get": {"summary": "List all catalog views + metadata",
                               "responses": {"200": {"description": "view list"}}}},
            "/views/{view}/schema": {"get": {"summary": "Column schema for a view",
                "parameters": [{"name": "view", "in": "path", "required": True,
                                "schema": {"type": "string"}}],
                "responses": {"200": {"description": "schema"}}}},
            "/data/{view}": {"get": {"summary": "Filtered read of a view",
                "parameters": [
            ...
            "/sql": {"post": {"summary": "Read-only SELECT over the catalog",
